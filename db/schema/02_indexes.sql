...
CREATE INDEX IF NOT EXISTS idx_people_movies_actor ON people_movies (people_id, movie_id) WHERE job = 'Actor';
CREATE INDEX IF NOT EXISTS idx_people_movies_movie_actor ON people_movies (movie_id, people_id) WHERE job = 'Actor';
